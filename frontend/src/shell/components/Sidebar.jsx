  ...
  return (
    <>
      ...
      <aside
        className={[
          // position & size
          "fixed inset-y-0 left-0 z-50 w-72 lg:w-64 border-r border-slate-200 bg-white flex flex-col",
          // animation (mobile)
      ...
      >
        ...
        <div className="h-16 flex items-center gap-3 px-4 border-b border-slate-200">
          ...
          <button
            type="button"
            onClick={onClose}
            className="ml-auto lg:hidden rounded-md p-2 hover:bg-slate-100"
